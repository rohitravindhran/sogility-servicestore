...
export default class NotifService {
  constructor(onRegister, onNotification, onAction) {
    this.lastId = 0;
    ...
    NotificationHandler.onAction(onAction);
  ...
  localNotif(title, body) {
    ...
    PushNotification.localNotification({
      ...
      // subtitle: 'My Notification Subtitl', // (optional) smaller title below notification title

      /* iOS and Android properties */
      id: this.lastId, // (optional) Valid unique 32 bit integer specified as string. default: Autogenerated Unique ID
      title: title, // (optional)
      message: body, // (required)
      userInfo: {screen: 'Bookings'}, // (optional) default: {} (using null throws a JSON value '<null>' error)
